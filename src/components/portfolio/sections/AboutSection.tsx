...
const AboutSection = () => {
  return (
    <div className="about-gradient rounded-xl p-8 flex items-center gap-8">
      <div className="flex-1 min-w-0">
        <h1 className="text-3xl font-bold text-white leading-tight mb-3" style={{ lineHeight: "1.15" }}>
          {personalInfo.name}
        </h1>
        <p className="text-white/90 text-sm leading-relaxed mb-5 max-w-lg" style={{ textWrap: "pretty" }}>
          {personalInfo.about}
        </p>
        <a
      ...
      {/* Photo placeholder */}
      <div className="hidden md:flex shrink-0 w-44 h-44 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/30 items-center justify-center overflow-hidden">
